...
NOT_OBTAINED = re.compile(r'未(?:取得|获取|获得|拿到|检索到)|尚未找到|没有?(?:取得|拿到|获取|获得|找到|收到)|'
                          r'(?:没有|尚无|未有)(?:本轮|本次|相关|足够|任何|直接)?证据(?:证明|表明|支持)|'
                          r'(?:没有|未)(?:向|给)(?:我们|我|本人|研究者)[^。；\n]*?提供|'
                          r'现有(?:资料|材料|信息).*?(?:没有|不含)|我没有.*?(?:记录|材料|资料|报表)')
UNKNOWN = re.compile(r'不知道|不清楚|不了解|未知|无法(?:确认|判断|提供|取得)|不能(?:确认|判断|提供)')
