...
export type Settings = { managed?: boolean; primary_model?: string | null; fallback_model?: string; reasoning_effort?: string | null; base_url: string; model: string; has_key: boolean; configured: boolean };
