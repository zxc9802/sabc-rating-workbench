...
export type Project = { assessment_review?: AssessmentReview; id: string; name: string; description?: string; project_type: string; version: number; messages: Message[]; last_grade?: string; updated_at: string; proposal?: Proposal; pending_patch?: RecordData; lifecycle?: Lifecycle; followup?: Followup | null; [key: string]: unknown };
