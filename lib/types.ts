...
export type Project = { interview?: { state: string; questions: string[] }; report_ready?: boolean; analysis_complete?: boolean; assessment_review?: AssessmentReview; id: string; name: string; description?: string; project_type: string; version: number; messages: Message[]; last_grade?: string; updated_at: string; proposal?: Proposal; pending_patch?: RecordData; lifecycle?: Lifecycle; followup?: Followup | null; [key: string]: unknown };
...
export type Job = { id: string; generate_report?: boolean; project_id?: string; status: 'running' | 'success' | 'failed' | 'cancelled'; phase?: 'queued' | 'working'; result?: unknown; error?: string; partial_reply?: string };
