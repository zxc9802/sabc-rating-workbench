...
function Workbench({ logout }: { logout: ReactNode }) {
  ...
  async function sendMessage(content = message) {
    if (!content.trim() || !detail || attachmentBusy) return;
    setStreamReply('');
